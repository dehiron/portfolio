...
const Header = () => {
    ...
    return (
        <header className="flex items-center md:items-baseline justify-between top-0 p-3 md:p-2 max-w-7xl mx-auto bg-white h-[66px]">
            ...
            { router.pathname.includes("contact") ?
                ...
                <div>
                    <div className="hidden md:inline-flex space-x-5">
                        <Scroll to="About" smooth={true} duration={600} offset={24}><div className="cursor-pointer"><p className="text-lg font-josefin">About</p></div></Scroll>
                        <Scroll to="Skills" smooth={true} duration={600} offset={24}><div className="cursor-pointer"><p className="text-lg font-josefin">Skills</p></div></Scroll>
                        <Scroll to="Projects" smooth={true} duration={600} offset={24}><div className="cursor-pointer"><p className="text-lg font-josefin">Projects</p></div></Scroll>
                        <Link href="/contact"><div className="cursor-pointer"><p className="text-lg font-josefin">Contact</p></div></Link>
                    </div>
